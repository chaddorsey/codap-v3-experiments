...
import { IPlotProps, IBarCover } from '../../components/graph/graphing-types';
...
jest.mock('../../components/graph/plots/bar-chart/bar-chart', () => ({
...
import { BarChart } from '../../components/graph/plots/bar-chart/bar-chart';
